...
Learn about the encoding formats used on Teleport. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Teleport does not
...
allows for quick reconstruction of encoded data. Teleport uses RLP to encode/decode Ethereum
...
Learn how [pending state](./pending_state.md) is handled on Teleport. {hide}
