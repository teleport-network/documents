...
Check the JSON-RPC methods supported on Teleport. {synopsis}
...
Make sure your `teleport start` call is not using the flag `minimum-gas-prices` because this value will be used instead of the one set on the configuration file.
