...
- [xibc/apps/transfer/v1/event.proto](#xibc/apps/transfer/v1/event.proto)
    - [EventAckPacketError](#xibc.apps.transfer.v1.EventAckPacketError)
    - [EventAckPacketSuccess](#xibc.apps.transfer.v1.EventAckPacketSuccess)
...
- [xibc/core/commitment/v1/commitment.proto](#xibc/core/commitment/v1/commitment.proto)
    ...
    - [MerkleRoot](#xibc.core.commitment.v1.MerkleRoot)
...
- [xibc/core/packet/v1/event.proto](#xibc/core/packet/v1/event.proto)
    ...
    - [EventRecvCleanPacket](#xibc.core.packet.v1.EventRecvCleanPacket)
    - [EventRecvPacket](#xibc.core.packet.v1.EventRecvPacket)
    - [EventSendCleanPacket](#xibc.core.packet.v1.EventSendCleanPacket)
...
- [xibc/core/packet/v1/packet.proto](#xibc/core/packet/v1/packet.proto)
    ...
    - [CleanPacket](#xibc.core.packet.v1.CleanPacket)
...
- [xibc/core/packet/v1/query.proto](#xibc/core/packet/v1/query.proto)
    - [QueryCleanPacketCommitmentRequest](#xibc.core.packet.v1.QueryCleanPacketCommitmentRequest)
    - [QueryCleanPacketCommitmentResponse](#xibc.core.packet.v1.QueryCleanPacketCommitmentResponse)
...
- [xibc/core/packet/v1/tx.proto](#xibc/core/packet/v1/tx.proto)
    ...
    - [MsgCleanPacket](#xibc.core.packet.v1.MsgCleanPacket)
    - [MsgCleanPacketResponse](#xibc.core.packet.v1.MsgCleanPacketResponse)
    - [MsgRecvCleanPacket](#xibc.core.packet.v1.MsgRecvCleanPacket)
    - [MsgRecvCleanPacketResponse](#xibc.core.packet.v1.MsgRecvCleanPacketResponse)
...
- [xibc/lightclients/eth/v1/eth.proto](#xibc/lightclients/eth/v1/eth.proto)
    - [ClientState](#xibc.lightclients.eth.v1.ClientState)
    - [ConsensusState](#xibc.lightclients.eth.v1.ConsensusState)
    - [Header](#xibc.lightclients.eth.v1.Header)
    - [Proof](#xibc.lightclients.eth.v1.Proof)
    - [StorageResult](#xibc.lightclients.eth.v1.StorageResult)
  
- [xibc/lightclients/tendermint/v1/tendermint.proto](#xibc/lightclients/tendermint/v1/tendermint.proto)
    - [ClientState](#xibc.lightclients.tendermint.v1.ClientState)
    - [ConsensusState](#xibc.lightclients.tendermint.v1.ConsensusState)
    - [Fraction](#xibc.lightclients.tendermint.v1.Fraction)
    - [Header](#xibc.lightclients.tendermint.v1.Header)
...
<a name="xibc.apps.transfer.v1.EventAckPacketError"></a>

### EventAckPacketError
EventAckPacketError is emitted on acknowledgement packet error
...
<a name="xibc.apps.transfer.v1.EventAckPacketSuccess"></a>

### EventAckPacketSuccess
EventAckPacketSuccess is emitted on acknowledgement packet success
...
UpgradeClientProposal defines a overnance proposal to overide an XIBC client state
...
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `ClientState` | [QueryClientStateRequest](#xibc.core.client.v1.QueryClientStateRequest) | [QueryClientStateResponse](#xibc.core.client.v1.QueryClientStateResponse) | ClientState queries an XIBC light client. | GET|/ibc/core/client/v1beta1/client_states/{chain_name}|
| `ClientStates` | [QueryClientStatesRequest](#xibc.core.client.v1.QueryClientStatesRequest) | [QueryClientStatesResponse](#xibc.core.client.v1.QueryClientStatesResponse) | ClientStates queries all the XIBC light clients of a chain. | GET|/ibc/core/client/v1beta1/client_states|
...
### MsgUpdateClient
MsgUpdateClient defines an sdk.Msg to update a XIBC client state using the given header.
...
<a name="xibc.core.commitment.v1.MerkleRoot"></a>
...
<a name="xibc.core.packet.v1.EventRecvCleanPacket"></a>

### EventRecvCleanPacket
EventRecvCleanPacket is emitted on receive clean packet
...
<a name="xibc.core.packet.v1.EventSendCleanPacket"></a>

### EventSendCleanPacket
EventSendCleanPacket is emitted on send clean packet
...
<a name="xibc.core.packet.v1.CleanPacket"></a>

### CleanPacket
CleanPacket defines a type that carries data across different chains through XIBC
...
| ----- | ---- | ----- | ----------- |
| `sequence` | [uint64](#uint64) |  | number corresponds to the order of sends and receives, where a Packet with an earlier sequence number must be sent and received before a Packet with a later sequence number. |
| `port` | [string](#string) |  | identifies the port on the sending chain and destination chain. |
| `source_chain` | [string](#string) |  | identifies the chain id of the sending chain. |
| `destination_chain` | [string](#string) |  | identifies the chain id of the receiving chain. |
| `relay_chain` | [string](#string) |  | identifies the chain id of the relay chain. |
...
<a name="xibc.core.packet.v1.QueryCleanPacketCommitmentRequest"></a>
...
<a name="xibc.core.packet.v1.QueryCleanPacketCommitmentResponse"></a>
...
| `CleanPacketCommitment` | [QueryCleanPacketCommitmentRequest](#xibc.core.packet.v1.QueryCleanPacketCommitmentRequest) | [QueryCleanPacketCommitmentResponse](#xibc.core.packet.v1.QueryCleanPacketCommitmentResponse) | CleanPacketCommitment queries a stored packet commitment hash. | GET|/xibc/core/packet/v1beta1/source_chains/{source_chain}/dest_chains/{dest_chain}/clean_packet_commitments|
...
<a name="xibc.core.packet.v1.MsgCleanPacket"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `clean_packet` | [CleanPacket](#xibc.core.packet.v1.CleanPacket) |  |  |
| `signer` | [string](#string) |  |  |
...
<a name="xibc.core.packet.v1.MsgCleanPacketResponse"></a>
...
<a name="xibc.core.packet.v1.MsgRecvCleanPacket"></a>
...
<a name="xibc.core.packet.v1.MsgRecvCleanPacketResponse"></a>
...
| `CleanPacket` | [MsgCleanPacket](#xibc.core.packet.v1.MsgCleanPacket) | [MsgCleanPacketResponse](#xibc.core.packet.v1.MsgCleanPacketResponse) | CleanPacket defines a rpc handler method for MsgCleanPacket. | |
| `RecvCleanPacket` | [MsgRecvCleanPacket](#xibc.core.packet.v1.MsgRecvCleanPacket) | [MsgRecvCleanPacketResponse](#xibc.core.packet.v1.MsgRecvCleanPacketResponse) | RecvCleanPacket defines a rpc handler method for MsgRecvCleanPacket. | |
...
<a name="xibc/lightclients/eth/v1/eth.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## xibc/lightclients/eth/v1/eth.proto



<a name="xibc.lightclients.eth.v1.ClientState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `header` | [Header](#xibc.lightclients.eth.v1.Header) |  |  |
| `chain_id` | [uint64](#uint64) |  |  |
| `contract_address` | [bytes](#bytes) |  |  |
| `trusting_period` | [uint64](#uint64) |  |  |
| `timeDelay` | [uint64](#uint64) |  |  |
| `blockDelay` | [uint64](#uint64) |  |  |
...
<a name="xibc.lightclients.eth.v1.ConsensusState"></a>
...
| `number` | [xibc.core.client.v1.Height](#xibc.core.client.v1.Height) |  |  |
| `root` | [bytes](#bytes) |  |  |
...
<a name="xibc.lightclients.eth.v1.Header"></a>
...
| `uncle_hash` | [bytes](#bytes) |  |  |
| `coinbase` | [bytes](#bytes) |  |  |
| `root` | [bytes](#bytes) |  |  |
| `tx_hash` | [bytes](#bytes) |  |  |
| `receipt_hash` | [bytes](#bytes) |  |  |
| `bloom` | [bytes](#bytes) |  |  |
| `difficulty` | [string](#string) |  |  |
| `height` | [xibc.core.client.v1.Height](#xibc.core.client.v1.Height) |  |  |
| `gas_limit` | [uint64](#uint64) |  |  |
| `gas_used` | [uint64](#uint64) |  |  |
| `time` | [uint64](#uint64) |  |  |
| `extra` | [bytes](#bytes) |  |  |
| `mix_digest` | [bytes](#bytes) |  |  |
| `nonce` | [uint64](#uint64) |  |  |
...
<a name="xibc.lightclients.eth.v1.Proof"></a>
...
| `nonce` | [string](#string) |  |  |
| `storage_hash` | [string](#string) |  |  |
| `account_proof` | [string](#string) | repeated |  |
| `storage_proof` | [StorageResult](#xibc.lightclients.eth.v1.StorageResult) | repeated |  |
...
<a name="xibc.lightclients.eth.v1.StorageResult"></a>
...
<a name="xibc/lightclients/tendermint/v1/tendermint.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## xibc/lightclients/tendermint/v1/tendermint.proto



<a name="xibc.lightclients.tendermint.v1.ClientState"></a>
...
| `trust_level` | [Fraction](#xibc.lightclients.tendermint.v1.Fraction) |  |  |
...
| `latest_height` | [xibc.core.client.v1.Height](#xibc.core.client.v1.Height) |  | latest height the client was updated to |
| `proof_specs` | [ics23.ProofSpec](#ics23.ProofSpec) | repeated | proof specifications used in verifying counterparty state |
| `MerklePrefix` | [xibc.core.commitment.v1.MerklePrefix](#xibc.core.commitment.v1.MerklePrefix) |  | commitment merkle prefix of the counterparty chain. |
| `timeDelay` | [uint64](#uint64) |  | period of transaction confirmation delay |
...
<a name="xibc.lightclients.tendermint.v1.ConsensusState"></a>
...
| `root` | [xibc.core.commitment.v1.MerkleRoot](#xibc.core.commitment.v1.MerkleRoot) |  | commitment root (i.e app hash) |
...
<a name="xibc.lightclients.tendermint.v1.Fraction"></a>
...
<a name="xibc.lightclients.tendermint.v1.Header"></a>
...
| `trusted_height` | [xibc.core.client.v1.Height](#xibc.core.client.v1.Height) |  |  |
