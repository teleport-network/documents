...
You will need to ensure that the version installed matches the one needed for th testnet. Check the Teleport [release page](https://github.com/tharsis/teleport/releases) for details on each release.
