...
preparing test network with chain-id "teleport_1276974-1"
...
```bash
teleport keys add test --recover --keyring-backend test
```

Check the balance of the account address:

```bash
teleport q bank balances [address]
```
